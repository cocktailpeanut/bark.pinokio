...
module.exports = {
  ...
  icon: "icon.png",
  description: "Upload a clean 20 seconds WAV file of the vocal persona you want to mimic, type your text-to-speech prompt and hit submit! A local version of https://huggingface.co/spaces/fffiloni/instant-TTS-Bark-cloning",
  menu: async (kernel) => {
